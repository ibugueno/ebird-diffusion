...
def log_variable(nombre, valor):
    """Guarda en el log el valor de una variable."""
    logging.info(f"{nombre}: {valor}")
...
def train(args):
    ...
    ########################
    logging.basicConfig(
    filename="Rislab_Event_influence_volume/logfile_MainTrain.log",  # Nombre del archivo de log
    ...
    for epoch_idx in range(num_epochs):
        ...
        log_variable(text_log, np.mean(losses))
