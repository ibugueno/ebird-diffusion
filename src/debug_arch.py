...
from UnetClassDEBUG import Unet
from UnetClassDEBUG import CombinedUnet
...
def infer(args, subset_ratio_=0.05, batch_size=768):
    ...
    model(xt, c_batch, torch.full((batch_size,), i, device=device))
...
if __name__ == '__main__':
    ...
    infer(args, subset_ratio_ = 0.25, batch_size=1)
